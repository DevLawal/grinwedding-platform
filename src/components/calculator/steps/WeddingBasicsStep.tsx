      ...
      <div className="mb-12">
        <div className="flex justify-between items-end mb-4">
          <div>
            ...
            <h2 className="text-2xl font-serif font-black text-text">Foundation Metrics</h2>
          </div>
          <p className="text-[10px] font-black uppercase tracking-widest text-text-dim">25% Complete</p>
        </div>
      ...
      <div className="space-y-12">
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <label htmlFor="city" className="text-sm font-black uppercase tracking-widest text-text">
          ...
          <select
            ...
            className="w-full bg-surface-2 border-2 border-transparent px-6 py-4 text-sm font-bold text-text focus:outline-none focus:border-purple transition-all appearance-none cursor-pointer"
          >
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-sm font-black uppercase tracking-widest text-text">Ceremonial Scope</h3>
          </div>
            ...
            {Object.entries(WEDDING_TYPE_NAMES).map(([value, label]) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`font-black text-xs uppercase tracking-widest mb-2 ${isActive ? 'text-text' : 'text-text-dim'}`}>{label}</div>
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-sm font-black uppercase tracking-widest text-text">Volume & Prestige</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              return (
                ...
                >
                  <div className={`font-black text-xs uppercase tracking-[0.15em] mb-1 ${isActive ? 'text-text' : 'text-text-dim'}`}>{scale.label}</div>
